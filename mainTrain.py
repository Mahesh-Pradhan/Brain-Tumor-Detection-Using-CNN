...
image_directory='F:\\Brain Tumour Detection\\datasets'
...
dataset=[] # will be storing images in rgb format
label=[]  # will be storing no/yes tumor corresponding to index of image in datasets.
